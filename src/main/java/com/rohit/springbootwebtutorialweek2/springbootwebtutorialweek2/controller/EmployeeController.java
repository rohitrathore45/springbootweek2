...
import com.rohit.springbootwebtutorialweek2.springbootwebtutorialweek2.exceptions.ResourceNotFoundException;
...
@RestController
@RequestMapping("employees")        // parent url for all the mapping field e.g. -> /employees/getSecretMessage or eg -> /employees/{employeeId}
public class EmployeeController {
    ...
    @GetMapping
    public ResponseEntity<List<EmployeeDTO>> getAllEmployees(@RequestParam(required = false,
            name = "inputAge") Integer age, @RequestParam(required = false) String sortBy){
